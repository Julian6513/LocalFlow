...
final class UpdateManager: ObservableObject {
    ...
    private let releasesURL = URL(string: "https://api.github.com/repos/Julian6513/PrivateFlow/releases?per_page=100")!
    ...
    func checkForUpdates(userInitiated: Bool) async {
        let currentBuildTag = Bundle.main.infoDictionary?["PrivateFlowBuildTag"] as? String
    ...
    private func performUpdate(downloadURL: URL, expectedSize: Int) async {
        ...
        let tempDir = fm.temporaryDirectory.appendingPathComponent("privateflow-update-\(UUID().uuidString)")
        ...
        let dmgPath = tempDir.appendingPathComponent("PrivateFlow.dmg")
        ...
        do {
            ...
            let stagingDir = fm.temporaryDirectory.appendingPathComponent("privateflow-staged-\(UUID().uuidString)")
