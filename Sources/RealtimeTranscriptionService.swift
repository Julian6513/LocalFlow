...
private let realtimeLog = OSLog(subsystem: "com.julian6513.privateflow", category: "RealtimeTranscription")
...
final class RealtimeTranscriptionService {
    ...
    private let stateQueue = DispatchQueue(label: "com.julian6513.privateflow.realtime.state")
