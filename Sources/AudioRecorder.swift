...
final class AudioRecorder: NSObject, ObservableObject, AVCaptureAudioDataOutputSampleBufferDelegate {
    ...
    private let sessionQueue = DispatchQueue(label: "com.julian6513.privateflow.capture.session")
    private let sampleBufferQueue = DispatchQueue(label: "com.julian6513.privateflow.capture.samples")
